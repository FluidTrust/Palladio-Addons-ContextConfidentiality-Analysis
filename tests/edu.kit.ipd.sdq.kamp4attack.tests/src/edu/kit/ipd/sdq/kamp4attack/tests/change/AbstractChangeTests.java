...
public abstract class AbstractChangeTests extends AbstractModelTest {
	...
	protected CompromisedAssembly createAssembly(final CredentialChange change) {
		return this.createAssembly(change,
				(AssemblyContextDetail) this.assembly.getAssemblyContexts__ComposedStructure());
	}

	protected CompromisedAssembly createAssembly(final CredentialChange change,
			final AssemblyContextDetail assemblyComponent) {
