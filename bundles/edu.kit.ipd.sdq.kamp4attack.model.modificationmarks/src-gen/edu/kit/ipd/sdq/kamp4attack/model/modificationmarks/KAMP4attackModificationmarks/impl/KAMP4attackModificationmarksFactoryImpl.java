...
public class KAMP4attackModificationmarksFactoryImpl extends EFactoryImpl implements KAMP4attackModificationmarksFactory
{
	...
	public EObject create(EClass eClass)
	{
		...
		{
			case KAMP4attackModificationmarksPackage.KAMP_4ATTACK_MODIFICATION_REPOSITORY: return (EObject)createKAMP4attackModificationRepository();
			case KAMP4attackModificationmarksPackage.KAMP_4ATTACK_SEED_MODIFICATIONS: return (EObject)createKAMP4attackSeedModifications();
			case KAMP4attackModificationmarksPackage.ATTACKER_SELECTION: return (EObject)createAttackerSelection();
			case KAMP4attackModificationmarksPackage.CREDENTIAL_CHANGE: return (EObject)createCredentialChange();
			case KAMP4attackModificationmarksPackage.COMPROMISED_RESOURCE: return (EObject)createCompromisedResource();
			case KAMP4attackModificationmarksPackage.COMPROMISED_ASSEMBLY: return (EObject)createCompromisedAssembly();
			case KAMP4attackModificationmarksPackage.CONTEXT_CHANGE: return (EObject)createContextChange();
			case KAMP4attackModificationmarksPackage.COMPROMISED_LINKING_RESOURCE: return (EObject)createCompromisedLinkingResource();
			case KAMP4attackModificationmarksPackage.COMPROMISED_SERVICE: return (EObject)createCompromisedService();
			case KAMP4attackModificationmarksPackage.SERVICE_RESTRICTION_CONTAINER: return (EObject)createServiceRestrictionContainer();
			case KAMP4attackModificationmarksPackage.COMPROMISED_DATA: return (EObject)createCompromisedData();
			case KAMP4attackModificationmarksPackage.DATAMODEL_CONTAINER: return (EObject)createDatamodelContainer();
			default:
