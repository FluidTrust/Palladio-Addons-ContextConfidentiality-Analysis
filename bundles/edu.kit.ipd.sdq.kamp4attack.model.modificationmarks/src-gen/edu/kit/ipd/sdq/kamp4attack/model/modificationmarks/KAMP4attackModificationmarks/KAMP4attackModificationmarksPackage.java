...
public interface KAMP4attackModificationmarksPackage extends EPackage
{
	 ...
	 * @generated
	 */
	int KAMP_4ATTACK_MODIFICATION_REPOSITORY = 0;
	 ...
	 * @ordered
	 */
	int KAMP_4ATTACK_MODIFICATION_REPOSITORY__CHANGE_PROPAGATION_STEPS = 0;
	 ...
	 * @ordered
	 */
	int KAMP_4ATTACK_MODIFICATION_REPOSITORY__SEED_MODIFICATIONS = 1;
	 ...
	 * @ordered
	 */
	int KAMP_4ATTACK_MODIFICATION_REPOSITORY_FEATURE_COUNT = 2;
	 ...
	 * @generated
	 */
	int KAMP_4ATTACK_SEED_MODIFICATIONS = 1;
	 ...
	 * @ordered
	 */
	int KAMP_4ATTACK_SEED_MODIFICATIONS__ATTACKCOMPONENT = 0;
	 ...
	 * @ordered
	 */
	int KAMP_4ATTACK_SEED_MODIFICATIONS_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int MODIFY_ENTITY__ID = IdentifierPackage.IDENTIFIER__ID;
	 ...
	 * @ordered
	 */
	int MODIFY_ENTITY__TOOLDERIVED = IdentifierPackage.IDENTIFIER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MODIFY_ENTITY__AFFECTED_ELEMENT = IdentifierPackage.IDENTIFIER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MODIFY_ENTITY__CAUSING_ELEMENTS = IdentifierPackage.IDENTIFIER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MODIFY_ENTITY_FEATURE_COUNT = IdentifierPackage.IDENTIFIER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__COMPROMISEDRESOURCE = 0;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__COMPROMISEDASSEMBLY = 1;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__CONTEXTCHANGE = 2;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__CHANGED = 3;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__COMPROMISEDLINKINGRESOURCE = 4;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__COMPROMISEDSERVICE = 5;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__SERVICERESTRICTIONCONTAINER = 6;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__COMPROMISEDDATA = 7;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE__DATAMODELCONTAINER = 8;
	 ...
	 * @ordered
	 */
	int CREDENTIAL_CHANGE_FEATURE_COUNT = 9;
	 ...
	 * @generated
	 */
	int COMPROMISED_LINKING_RESOURCE = 8;
	 ...
	 * @generated
	 */
	int SERVICE_RESTRICTION_CONTAINER = 10;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.KAMP4attackModificationRepository#getChangePropagationSteps <em>Change Propagation Steps</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Change Propagation Steps</em>'.
	 * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.KAMP4attackModificationRepository#getChangePropagationSteps()
	 * @see #getKAMP4attackModificationRepository()
	 * @generated
	 */
	EReference getKAMP4attackModificationRepository_ChangePropagationSteps();

	/**
	 * Returns the meta object for the containment reference '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.KAMP4attackModificationRepository#getSeedModifications <em>Seed Modifications</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Seed Modifications</em>'.
	 * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.KAMP4attackModificationRepository#getSeedModifications()
	 * @see #getKAMP4attackModificationRepository()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#isToolderived <em>Toolderived</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Toolderived</em>'.
	 * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#isToolderived()
	 * @see #getModifyEntity()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#getAffectedElement <em>Affected Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Affected Element</em>'.
	 * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#getAffectedElement()
	 * @see #getModifyEntity()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#getCausingElements <em>Causing Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Causing Elements</em>'.
	 * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.ModifyEntity#getCausingElements()
	 * @see #getModifyEntity()
	 * @generated
	 */
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference KAMP_4ATTACK_MODIFICATION_REPOSITORY__CHANGE_PROPAGATION_STEPS = eINSTANCE.getKAMP4attackModificationRepository_ChangePropagationSteps();
		 ...
		 * @generated
		 */
		EReference KAMP_4ATTACK_MODIFICATION_REPOSITORY__SEED_MODIFICATIONS = eINSTANCE.getKAMP4attackModificationRepository_SeedModifications();
		 ...
		 * @generated
		 */
		EAttribute MODIFY_ENTITY__TOOLDERIVED = eINSTANCE.getModifyEntity_Toolderived();
		 ...
		 * @generated
		 */
		EReference MODIFY_ENTITY__AFFECTED_ELEMENT = eINSTANCE.getModifyEntity_AffectedElement();
		 ...
		 * @generated
		 */
		EReference MODIFY_ENTITY__CAUSING_ELEMENTS = eINSTANCE.getModifyEntity_CausingElements();
