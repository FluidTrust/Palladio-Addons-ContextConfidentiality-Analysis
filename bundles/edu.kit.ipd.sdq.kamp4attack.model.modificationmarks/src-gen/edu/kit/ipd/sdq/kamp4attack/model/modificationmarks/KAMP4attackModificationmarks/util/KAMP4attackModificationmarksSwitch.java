	...
	protected T1 doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case KAMP4attackModificationmarksPackage.MODIFY_ENTITY:
			{
				...
				if (result == null) result = caseIdentifier(modifyEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KAMP4attackModificationmarksPackage.ATTACKER_SELECTION:
			{
				...
				if (result == null) result = caseIdentifier(attackerSelection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case KAMP4attackModificationmarksPackage.COMPROMISED_RESOURCE:
			{
				...
				if (result == null) result = caseIdentifier(compromisedResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KAMP4attackModificationmarksPackage.COMPROMISED_ASSEMBLY:
			{
				...
				if (result == null) result = caseIdentifier(compromisedAssembly);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KAMP4attackModificationmarksPackage.CONTEXT_CHANGE:
			{
				...
				if (result == null) result = caseIdentifier(contextChange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KAMP4attackModificationmarksPackage.COMPROMISED_LINKING_RESOURCE:
			{
				...
				if (result == null) result = caseIdentifier(compromisedLinkingResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KAMP4attackModificationmarksPackage.COMPROMISED_SERVICE:
			{
				...
				if (result == null) result = caseIdentifier(compromisedService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case KAMP4attackModificationmarksPackage.COMPROMISED_DATA:
			{
				...
				if (result == null) result = caseIdentifier(compromisedData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
