...
public class KAMP4attackModificationmarksPackageImpl extends EPackageImpl implements KAMP4attackModificationmarksPackage
{
	...
	{
		return (EReference)kamp4attackModificationRepositoryEClass.getEStructuralFeatures().get(0);
	}
	...
	{
		return (EReference)kamp4attackModificationRepositoryEClass.getEStructuralFeatures().get(1);
	}
	...
	{
		return (EAttribute)modifyEntityEClass.getEStructuralFeatures().get(0);
	}
	...
	{
		return (EReference)modifyEntityEClass.getEStructuralFeatures().get(1);
	}
	...
	{
		return (EReference)modifyEntityEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(kamp4attackModificationRepositoryEClass, KAMP_4ATTACK_MODIFICATION_REPOSITORY__CHANGE_PROPAGATION_STEPS);
		createEReference(kamp4attackModificationRepositoryEClass, KAMP_4ATTACK_MODIFICATION_REPOSITORY__SEED_MODIFICATIONS);
		...
		createEAttribute(modifyEntityEClass, MODIFY_ENTITY__TOOLDERIVED);
		createEReference(modifyEntityEClass, MODIFY_ENTITY__AFFECTED_ELEMENT);
		createEReference(modifyEntityEClass, MODIFY_ENTITY__CAUSING_ELEMENTS);
	...
	public void initializePackageContents()
	{
		...
		modifyEntityEClass.getESuperTypes().add(theIdentifierPackage.getIdentifier());
		g1 = createEGenericType(this.getModifyEntity());
		EGenericType g2 = createEGenericType(theAttackerPackage.getAttacker());
		...
		initEReference(getKAMP4attackModificationRepository_ChangePropagationSteps(), this.getCredentialChange(), null, "changePropagationSteps", null, 0, -1, KAMP4attackModificationRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getKAMP4attackModificationRepository_SeedModifications(), this.getKAMP4attackSeedModifications(), null, "seedModifications", null, 1, 1, KAMP4attackModificationRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getModifyEntity_Toolderived(), ecorePackage.getEBoolean(), "toolderived", null, 1, 1, ModifyEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(modifyEntityEClass_T);
		initEReference(getModifyEntity_AffectedElement(), g1, null, "affectedElement", null, 1, 1, ModifyEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModifyEntity_CausingElements(), theEcorePackage.getEObject(), null, "causingElements", null, 0, -1, ModifyEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
