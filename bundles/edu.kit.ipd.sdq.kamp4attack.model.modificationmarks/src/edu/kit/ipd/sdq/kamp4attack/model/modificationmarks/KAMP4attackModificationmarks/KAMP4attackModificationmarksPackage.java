...
public interface KAMP4attackModificationmarksPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.AttackComponentImpl <em>Attack Component</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.AttackComponentImpl
     * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.KAMP4attackModificationmarksPackageImpl#getAttackComponent()
     * @generated
     */
    int ATTACK_COMPONENT = 4;
     ...
     * @ordered
     */
    int ATTACK_COMPONENT__AFFECTED_ELEMENT = MODIFY_ENTITY__AFFECTED_ELEMENT;
     ...
     * @ordered
     */
    int ATTACK_COMPONENT__CAUSING_ELEMENTS = MODIFY_ENTITY__CAUSING_ELEMENTS;
     ...
     * @ordered
     */
    int ATTACK_COMPONENT__ID = MODIFY_ENTITY__ID;
     ...
     * @ordered
     */
    int ATTACK_COMPONENT__TOOLDERIVED = MODIFY_ENTITY__TOOLDERIVED;
     ...
     * @ordered
     */
    int ATTACK_COMPONENT__USER_DECISION = MODIFY_ENTITY__USER_DECISION;

    /**
     * The number of structural features of the '<em>Attack Component</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int ATTACK_COMPONENT_FEATURE_COUNT = MODIFY_ENTITY_FEATURE_COUNT + 0;

    /**
     * The number of operations of the '<em>Attack Component</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int ATTACK_COMPONENT_OPERATION_COUNT = MODIFY_ENTITY_OPERATION_COUNT + 0;
    ...
    /**
     * Returns the meta object for class '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.AttackComponent <em>Attack Component</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Attack Component</em>'.
     * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.AttackComponent
     * @generated
     */
    EClass getAttackComponent();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '{@link edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.AttackComponentImpl <em>Attack Component</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.AttackComponentImpl
         * @see edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarks.impl.KAMP4attackModificationmarksPackageImpl#getAttackComponent()
         * @generated
         */
        EClass ATTACK_COMPONENT = eINSTANCE.getAttackComponent();
