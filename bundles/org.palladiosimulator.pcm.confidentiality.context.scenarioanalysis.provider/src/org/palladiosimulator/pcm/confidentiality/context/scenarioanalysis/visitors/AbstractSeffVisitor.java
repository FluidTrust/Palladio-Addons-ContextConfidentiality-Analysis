...
public class AbstractSeffVisitor<T> extends SeffSwitch<Set<T>> {
	 ...
	 */
	@Override
	public Set<T> caseAbstractInternalControlFlowAction(
		...
		if (action instanceof RecoveryAction) {
			...
			return doSwitch(action.getSuccessor_AbstractAction());
		} else {
			return null;
		}
	}
	...
	public Set<T> caseBranchAction(final BranchAction action) {
		...
		for (AbstractBranchTransition abt : abtList) {
			list.addAll(doSwitch(abt));
		}
		list.addAll(doSwitch(action.getSuccessor_AbstractAction()));
		return list;
	}
	 ...
	 */
	@Override
	public Set<T> caseCollectionIteratorAction(
	 ...
	 */
	@Override
	public Set<T> caseGuardedBranchTransition(
	 ...
	 */
	@Override
	public Set<T> caseProbabilisticBranchTransition(
	 ...
	 */
	@Override
	public Set<T> caseResourceDemandingBehaviour(
			final ResourceDemandingBehaviour behaviour) {
		return doSwitch(getStartAction(behaviour));
	}
	 ...
	 */
	@Override
	public Set<T> caseResourceDemandingSEFF(
