...
public class ModelInputTab extends AbstractLaunchConfigurationTab {
    ...
    public void performApply(final ILaunchConfigurationWorkingCopy configuration) {
        configuration.setAttribute(Constants.REPOSITORY_MODEL_LABEL.getConstant(), this.repositoryTextField.getText());
        configuration.setAttribute(Constants.ALLOCATION_MODEL_LABEL.getConstant(), this.allocationTextField.getText());
        configuration.setAttribute(Constants.CONTEXT_MODEL_LABEL.getConstant(), this.contextTextField.getText());
        configuration.setAttribute(Constants.DATA_MODEL_LABEL.getConstant(), this.dataTextField.getText());
        configuration.setAttribute(Constants.ATTACKER_MODEL_LABEL.getConstant(), this.adversaryTextField.getText());
        configuration.setAttribute(Constants.ANALYSIS_TYPE_LABEL.getConstant(), this.analysisCombo.getText());
        configuration.setAttribute(Constants.USAGE_MODEL_LABEL.getConstant(), this.usageTextField.getText());
        configuration.setAttribute(Constants.MODIFIACTION_MODEL_LABEL.getConstant(),
    ...
    public void createControl(final Composite parent) {
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.USAGE_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.REPOSITORY_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.ALLOCATION_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.CONTEXT_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.DATA_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.ATTACKER_MODEL_LABEL.getConstant(),
        ...
        TabHelper.createFileInputSection(this.comp, modifyListener, Constants.MODIFIACTION_MODEL_LABEL.getConstant(),
