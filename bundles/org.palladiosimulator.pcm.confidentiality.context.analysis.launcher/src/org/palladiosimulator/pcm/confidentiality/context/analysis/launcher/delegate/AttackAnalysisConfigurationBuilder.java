...
public class AttackAnalysisConfigurationBuilder extends ContextAnalysisConfigurationBuilder {
    ...
    public AttackAnalysisConfigurationBuilder(ILaunchConfiguration configuration, String mode) throws CoreException {
    ...
    public void fillConfiguration(AbstractWorkflowBasedRunConfiguration configuration) throws CoreException {
        ...
        config.setModificationModel(getURI(Constants.MODIFIACTION_MODEL_LABEL.getConstant()));
        config.setAttackModel(getURI(Constants.ATTACKER_MODEL_LABEL.getConstant()));
