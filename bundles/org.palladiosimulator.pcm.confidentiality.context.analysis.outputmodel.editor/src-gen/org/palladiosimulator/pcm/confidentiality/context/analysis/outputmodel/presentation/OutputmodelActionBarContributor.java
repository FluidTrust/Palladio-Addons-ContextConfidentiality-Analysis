...
/**
 * This is the action bar contributor for the Outputmodel model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class OutputmodelActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            OutputmodelEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                OutputmodelActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
            OutputmodelEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return OutputmodelActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (OutputmodelActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) OutputmodelActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                OutputmodelEditorPlugin.INSTANCE.getString("_UI_OutputmodelEditor_menu"),
                "org.palladiosimulator.pcm.confidentiality.context.analysis.outputmodelMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                OutputmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                OutputmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
