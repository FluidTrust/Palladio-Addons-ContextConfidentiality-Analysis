 ...
 * @generated
 */
public class KAMP4attackModificationmarksActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            KAMP4attackModificationsmarksEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                KAMP4attackModificationmarksActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
            KAMP4attackModificationsmarksEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return KAMP4attackModificationmarksActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (KAMP4attackModificationmarksActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) KAMP4attackModificationmarksActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                KAMP4attackModificationsmarksEditorPlugin.INSTANCE
                    .getString("_UI_KAMP4attackModificationmarksEditor_menu"),
                "edu.kit.ipd.sdq.kamp4attack.model.modificationmarks.KAMP4attackModificationmarksMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                KAMP4attackModificationsmarksEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                KAMP4attackModificationsmarksEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
