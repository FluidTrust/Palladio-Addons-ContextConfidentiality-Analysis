...
public class OutputmodelFactoryImpl extends EFactoryImpl implements OutputmodelFactory {
    ...
    public static OutputmodelFactory init() {
        try {
            OutputmodelFactory theOutputmodelFactory = (OutputmodelFactory) EPackage.Registry.INSTANCE
                    .getEFactory(OutputmodelPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        ...
        case OutputmodelPackage.SCENARIO_OUTPUT:
            return (EObject) createScenarioOutput();
        case OutputmodelPackage.ANALYSIS_RESULTS:
            return (EObject) createAnalysisResults();
        default:
